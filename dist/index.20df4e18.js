...
function getfromSessionStorage() {
    ...
    if (!localCoordinates) //if local coordinates not found
...
function getLocation() {
    if (navigator.geolocation) //this is geo location api/syntax for finding coordinates
    navigator.geolocation.getCurrentPosition(showPosition);
    else alert("Your Browser doesnot have Geo Location support");
}
...
//# sourceMappingURL=index.20df4e18.js.map
